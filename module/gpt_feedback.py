...
def speichere_gpt_feedback_in_supabase():
    ...
    gpt_row = {
        ...
        "gpt_feedback": st.session_state.get("gpt_feedback", ""),
        "gpt_amboss_feedback": st.session_state.get("gpt_amboss_feedback", ""),
        "Client": st.session_state.get("feedback_client_label", "Chat_GPT"),
        "chatverlauf": verlauf,
